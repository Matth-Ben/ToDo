  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between gap-4 mb-8">
      ...
      <input
        ...
        class="w-full bg-gray-700 text-white p-2 rounded flex-1"
        @keyup.enter="addTask"
      />
    ...
    <button @click="toggleShowArchives" class="text-gray-400 hover:text-gray-300 pt-4">
